...
class EstablishmentsControllerTest < ActionController::TestCase
  ...
  test "should create establishment" do
    assert_difference('Establishment.count') do
      post :create, establishment: { address: @establishment.address, name: @establishment.name, telephone: @establishment.telephone, website: @establishment.website }
    end
  ...
  test "should update establishment" do
    patch :update, id: @establishment, establishment: { address: @establishment.address, name: @establishment.name, telephone: @establishment.telephone, website: @establishment.website }
    assert_redirected_to establishment_path(assigns(:establishment))
  end
